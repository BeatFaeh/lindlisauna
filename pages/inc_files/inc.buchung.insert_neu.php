...
if($error === false) 
{
	...
	# 4.1 Personendaten in Tabelle tbl_buchung eintragen
    ...
    <tr><td'.$style_footer.'>Kosten total</td><td'.$style_data_right.'><b>CHF '.number_format($kosten_total, 2, ".", "'").'</b></td></tr>
    </table>';
...
# Beim Starten sieht der Kunde diese Eingabe-Maske des Formular Termin Buchung
	...
	while ($field = $result -> fetch_array(MYSQLI_ASSOC))
	{
		...
		echo "
		<tr>
		    <td style='vertical-align: text-top;' rowspan='5'><b>".$field['id_angebot'].".&nbsp;Angebot&nbsp;&nbsp;&nbsp;</b></td>
		    <td><input type='radio' id='html' name='angebot' value='".$field['id_angebot']."'></td>
		</tr>
		<tr>
		    <td colspan='2' style='vertical-align: text-top;' colspan='2'><b>".$field['bezeichnung']."</b></td>
		    
		</tr>
		<tr>
		    <td colspan='2' style='vertical-align: text-top;'>Dauer&nbsp;   </td><td>".$field['dauer_minuten']." Minuten</td>
		</tr>
	    <tr>
			<td colspan='2' style='vertical-align: text-top;'>Beschreibung&nbsp;  </td><td>".nl2br($field['beschreibung'])."</td>
		</tr>
		<tr>
		    <td colspan='2' style='vertical-align: text-top;'>Kosten[CHF]&nbsp;   </td><td>".number_format($field['kosten'],2)."</td>
		</tr>
		<tr>
		    <td colspan='2'>&nbsp;</td>
		</tr>

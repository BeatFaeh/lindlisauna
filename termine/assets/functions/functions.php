          ...
          initialView: 'dayGridMonth'
            ...
            plugins: ['interaction', 'dayGrid'],
				...
				echo "
					{
						id: '".$row['id']."',
						title: '".mb_convert_encoding($row['title'], 'UTF-8', mb_list_encodings())."', // Fix for the PHP 8.2 + version
		...
		<div class='modal-dialog'>
			<div class='modal-content'>
				<div class='modal-header'>
					...
					<h4><i class='fa fa-calendar' aria-hidden='true'></i> Reservations Details</h4>
				</div>
				...
				<div class='modal-body'>
					<div class='table-responsive'>
						...
						<div class='col-md-12'>
							...
							<h4>Datum</h4>
							<p>vom <span id='startTime'></span>
							<br>bis <span id='endTime'></span></p>
...
-->
					...
					<div class='form-group col-md-4'>
						<label class='col-md-3 control-label' for='end'>Enddatum</label>

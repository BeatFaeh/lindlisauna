					...
					<div class="row row-bottom-padded-md">
						...
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<p>
                                ...
                                <br>
                                          <img src="<?php echo WB_URL;?>/pages/rhysauna_logo.png" width="35%">
                                </a>
							</p>
							
					<div align="center">
					<div style="width:450px;height:366.6px">						
	
		<iframe scrolling="no" src="https://meteo.search.ch/widget/Schaffhausen" style="border:0;width:100%;height:100%"></iframe>
</div>
</div>
